...
class _CreateProfile extends State<CreateProfile> {
  ...
  int selectedNumber = 0; // Variable to store the selected number
  ...
  Future<void> createProfile() async {
    ...
    //  String languages = languageController.text;
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse('${ApiConfig.baseUrl}createProfileLeader'),
        headers: headers,
  ...
  void showSuccessDialog(BuildContext context, String message) {
    CommonDialog.showSuccessDialog(context, message, navitoloco);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
          padding: EdgeInsets.fromLTRB(72, 0, 72, 10),
          child: SizedBox(
...
class Leaderwelcome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.transparent,
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                        child: Text(
                          "Start the adventure now".tr(), // Modify button text
                          textAlign: TextAlign.center,
                          style: GoogleFonts.montserrat(
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w800,
