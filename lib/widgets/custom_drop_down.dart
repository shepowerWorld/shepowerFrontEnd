...
class CustomDropDown extends StatelessWidget {
  ...
  Widget get dropDownWidget => SizedBox(
        ...
        child: DropdownButtonFormField(
          ...
          icon: icon,
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumMontserratGray50002,
          items: items?.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              ...
              child: Text(
                ...
                style:
                    hintStyle ?? CustomTextStyles.bodyMediumMontserratGray50002,
              ),
            );
          }).toList(),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumMontserratGray50002,
        prefixIcon: prefix,
